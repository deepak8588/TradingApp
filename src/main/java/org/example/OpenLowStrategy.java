...
public class OpenLowStrategy {
        ...
        private static void placeMarketOrder(String symbol, double lastTradedPrice, double openPrice) throws IOException, KiteException {
            ...
            System.out.println("Order successfully placed with Order id:" + buyOrder.orderId);

            //Place SL order
            orderParams.transactionType = Constants.TRANSACTION_TYPE_SELL;
            orderParams.price = lastTradedPrice-2L;
            orderParams.tag = "DeepakAlgoOrder1";
            Order sellOrder = kiteSdk.placeOrder(orderParams, Constants.VARIETY_REGULAR);
            System.out.println("Stoploss order successfully placed with Order id:" + sellOrder.orderId);
        }
